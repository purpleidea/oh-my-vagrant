...
...
```
The `192.168.124.3   omv.example3.com    omv` line represents a virtual IP address
reserved on every VM in the cluster. It's unused by default and can be used by
